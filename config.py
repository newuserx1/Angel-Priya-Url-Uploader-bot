...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5902879899:AAG08FPzkWC-FxCDyh5a7q0oxD0pZwJ5MyM")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 27747795))
    API_HASH = os.environ.get("API_HASH","a8b48e9880db88e4150f7f4c772d29a3")
    # Get these values from my.telegram.org
    # Array to store users who are authorized to use the bot
    AUTH_USERS = set(int(x) for x in os.environ.get("AUTH_USERS", "5619679352").split())
    ...
    HTTP_PROXY = os.environ.get("HTTP_PROXY", "192.248.80.51:3128")
